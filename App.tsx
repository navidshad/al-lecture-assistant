...
function AppContent() {
  ...
  const resetLecture = useCallback(() => {
    setSlides([]);
    setError(null);
  }, []);
  ...
  return <LectureView slides={slides} onEndSession={resetLecture} selectedLanguage={selectedLanguage} selectedVoice={selectedVoice} selectedModel={selectedModel} />;
}
